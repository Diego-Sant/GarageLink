    ...
    return (
        <div className="h-[800px] flex flex-col">
            <div className="flex-[1] flex flex-col gap-[20px] overflow-y-auto">
                ...
                <div className="bg-white dark:bg-[#1a1a1a] hover:bg-white/60 
                p-[20px] rounded-[10px] dark:text-white dark:hover:bg-[#4d4d4d]
                flex items-center cursor-pointer">
                    ...
                    src="https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Imagem de perfil" />
            ...
            {chat && (
                ...
                justify-between h-[100%] dark:dark:bg-[#1a1a1a]">
                    <div>
                        ...
                        <div className="bg-[#fece51]/80 p-[20px] font-bold flex items-center 
                        ...
                        <div className="overflow-y-auto h-[290px] p-[20px] flex flex-col gap-[20px]">
                            ...
                            <div className="flex flex-col items-start text-start gap-y-1">
                                <p className="flex flex-wrap max-w-[500px] bg-[#fece51]/20 
                                dark:bg-[#fece51]/80 rounded-[10px] p-[5px]">
                                ...
                                <span className="text-[12px] dark:bg-[#fece51]/60
                                    bg-[#fece51]/40 rounded-[5px] p-[2px]">
                                    1 hora atrás
                                </span>
                            </div>

                            <div className="flex flex-col items-end text-right gap-y-1">
                                <p className="flex flex-wrap max-w-[500px] bg-[#fece51]/70 
                                    dark:bg-[#fece51] rounded-[10px] p-[5px]">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, libero quisquam voluptatibus exercitationem dolore recusandae fugiat eius quo veritatis placeat. Eum, quo? Nisi eius rem eaque veniam incidunt sit dignissimos.
                                </p>
                                <span className="text-[12px] dark:bg-[#fece51]/60
                                    bg-[#fece51]/40 rounded-[5px] p-[2px]">
                    ...
                    <div className="border-t-[2px] border-[#fece51]/80 h-[60px] flex items-center justify-between overflow-y-auto">
                        <textarea className="flex-[3] h-[100%] border-0 p-[20px] 
                        resize-none dark:dark:bg-[#1a1a1a] dark:text-white" name="" id=""></textarea>
