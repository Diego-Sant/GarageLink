        ...
        <div className="flex flex-col lg:flex-row gap-[20px]">
            ...
            <div className="flex-[3] flex flex-col justify-between gap-[10px]">
                ...
                {location.pathname === "/carros" ? (
                    ...
                    <p className="flex gap-[5px] -mt-[1.8rem] sm:-mt-[2.8rem]
                        md:-mt-[1rem] xl:-mt-[2.1rem] text-[14px] text-[#888] dark:text-[#E0E0E0]">
                ...
                {location.pathname === "/carros" ? (
                    <p className="text-[20px] -mt-[1.1rem] sm:-mt-[2.2rem] 
                        md:-mt-[0.5rem] xl:-mt-[1.7rem] font-[500] bg-[#fece51]/40 
                        dark:bg-[#fece51] rounded-[5px] p-[5px] w-max">
                        {priceDisplay}
                    </p>
                ) : (
                ...
                <div className="flex -mt-[1rem] sm:-mt-[1.9rem] md:-mt-0 justify-between gap-[10px] items-center">
                    ...
                    {location.pathname === "/carros" ? (
                        <div className="grid grid-cols-2 md:grid-cols-3 xl:flex gap-[20px] 
                            text-[14px] items-center">
                            
                            <div className="flex justify-center items-center 
                                gap-[5px] bg-[#f5f5f5] dark:bg-[#1a1a1a] dark:text-white 
                                p-[5px] rounded-[5px]">
                                <span className="truncate max-w-[80px]">{item.brand}</span>
                            </div>

                            <div className="flex justify-center items-center 
                                gap-[5px] bg-[#f5f5f5] p-[5px] dark:bg-[#1a1a1a] dark:text-white 
                                rounded-[5px]">
                    ...
                    {location.pathname === "/carros" ? (
                        <div className="flex flex-col xl:flex-row gap-[20px]">
                            ...
                            <div disabled={loading} onClick={handleFavorite} className={`flex justify-center border 
                                ...
                                : 'bg-white border-[#999] hover:bg-white/20 disabled:bg-gray-600/20'}
